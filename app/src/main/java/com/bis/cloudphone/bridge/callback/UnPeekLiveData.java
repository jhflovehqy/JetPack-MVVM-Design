package com.bis.cloudphone.bridge.callback;
...
/**
 * 通过反射进行对LiveData版本号的修改
 * 避免在先发送后注册的过程中，observer仍然收到了先注册的消息
 * LiveData 需要对当前的版本进行对比 ， 通过反射可以修改当前版本号，在对比版本时return掉防止继续分发
 * @param <T>
 */
