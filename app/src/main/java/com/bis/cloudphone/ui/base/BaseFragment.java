 ...
 */
public abstract class BaseFragment<ViewDataBind extends ViewDataBinding> extends Fragment {
...
//                mTvStrictModeTip.setText(R.string.debug_fragment_databinding_warning);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ViewDataBind binding = DataBindingUtil.inflate(inflater, dataBindingConfig.getLayoutId(), container, false);
        binding.setLifecycleOwner(this);
//        binding.setVariable(BR.dateBean, dataBindingConfig.getStateViewModel());
